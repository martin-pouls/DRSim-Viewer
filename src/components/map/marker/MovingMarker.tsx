...
import {BaseMovingMarker} from './BaseMovingMarker'
import {LatLngTuple} from "leaflet";

const defaultPosition: LatLngTuple = [0, 0]

const computeBearing = (previousPosition: LatLngTuple = defaultPosition, nexPosition: LatLngTuple) => {
...
const createMarker = ({ position, previousPosition, rotationAngle, ...options }, ctx) => {
    ...
    const instance = new BaseMovingMarker(position, { ...options, bearingAngle })
...
// @ts-ignore
export const MovingMarker = createLayerComponent(createMarker, updateMarker)